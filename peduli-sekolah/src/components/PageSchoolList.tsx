...
const SchoolListClient = ({ schools }: { schools: SchoolProfile[] }) => {
  ...
  return (
    <>
      {schools.map((school) => (
        <div key={school._id} className="border shadow-lg rounded-xl p-5 mb-5">
          <div className="flex">
            <img
            ...
            <div className="w-full">
              ...
              <p className="my-3 text-sm">
                Contact Us:{" "}
                <a href={`tel:${school.phoneNumber}`} className="text-blue-500">
                  {school.phoneNumber}
                </a>{" "}
                <br />
                Total Post: 2
